                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                    ...
                                    <tbody id ="myTable">
                                        ...
                                        <tr>
                                            <td class="tm-product-name"><a href="?controller=etudiant&action=profil&id=<?= e($val['idetudiant']) ?>" class="tm-link-black"><?= $val["Nom"]?> <?= $val["Prenom"]?></a></td>
                                            <td class="text-center"><a href="?controller=etudiant&action=profil&id=<?= e($val['idetudiant']) ?>" class="tm-link-black">BOS</a></td>
                                            <td><a href="?controller=etudiant&action=profil&id=<?= e($val['idetudiant']) ?>" class="tm-link-black"><?=  $val["Date_heure"] === null ? 'null' : e($val["Date_heure"]) ?></a></td>
                                        </tr>
                                        <?php endforeach ?>
                                    </tbody>
                                </table>
